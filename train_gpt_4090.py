...
assert world_size == 8 // args.world_size_scale_down # this code is designed for 8xH100
...
optimizer1 = DistAdam(scalar_params + head_params + embed_params, lr=0.008 / args.lr_scale_down, betas=(0.8, 0.95), eps=1e-10, weight_decay=0.0)
optimizer2 = Muon(hidden_matrix_params, lr=0.05 / args.lr_scale_down, momentum=0.95, weight_decay=0.0)
